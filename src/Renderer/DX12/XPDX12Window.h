...
{
  public:
    explicit XPDX12Window(XPDX12Renderer* renderer);
    ~XPDX12Window();
    void initialize();
    void finalize();
    void pollEvents();
    ...
    [[nodiscard]] XPDX12Renderer* getRenderer() const;
    ...
    void createSurface(int* adapterIndex, int* outputIndex);

  private:
    XPDX12Renderer* const _renderer                = nullptr;
