...
class XPMetalMemorylessBuffer final : public XPMetalBuffer
{
  public:
    XPMetalMemorylessBuffer(XPIRenderer* const renderer, size_t numBytes);
    ~XPMetalMemorylessBuffer() final;
