...
class XPMetalManagedBuffer final : public XPMetalBuffer
{
  public:
    XPMetalManagedBuffer(XPIRenderer* const renderer, size_t numBytes);
    ~XPMetalManagedBuffer() final;
    void allocate() override;
    void deallocate() override;
    void synchronizeFromGPU(size_t offset, size_t numBytes) final;
    void synchronizeToGPU(size_t offset, size_t numBytes) final;
  ...
  private:
    void*  _alignedAllocatedMemory;
    size_t _alignedMemorySize;
};
