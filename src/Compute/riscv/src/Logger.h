...
#define WARNING_LEVEL_EMERGENCY 1
#define WARNING_LEVEL_ALERT     2
#define WARNING_LEVEL_CRITICAL  3
#define WARNING_LEVEL_ERROR     4
#define WARNING_LEVEL_WARNING   5
#define WARNING_LEVEL_NOTICE    6
#define WARNING_LEVEL_INFO      7
#define WARNING_LEVEL_DEBUG     8

#define WARNING_LEVEL WARNING_LEVEL_NONE

#define LOG(TAG, MSG)       printf(TAG MSG "\n");
#define LOGV(TAG, MSG, ...) printf(TAG MSG "\n", __VA_ARGS__);

#if WARNING_LEVEL >= WARNING_LEVEL_EMERGENCY
...
#if WARNING_LEVEL >= WARNING_LEVEL_ALERT
...
#if WARNING_LEVEL >= WARNING_LEVEL_CRITICAL
...
#if WARNING_LEVEL >= WARNING_LEVEL_ERROR
...
#if WARNING_LEVEL >= WARNING_LEVEL_WARNING
...
#if WARNING_LEVEL >= WARNING_LEVEL_NOTICE
...
#if WARNING_LEVEL >= WARNING_LEVEL_INFO
...
#if WARNING_LEVEL >= WARNING_LEVEL_DEBUG
