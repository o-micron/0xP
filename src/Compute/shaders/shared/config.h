...
#define XP_XPU_CONFIG_HMM_FRAMEBUFFER_PTR  (XP_XPU_CONFIG_HMM_END_HEAP_PTR + 0x05U)     // FRAMEBUFFER START (0x1)
#define XP_XPU_CONFIG_HMM_FRAMEMEMPOOL_PTR (XP_XPU_CONFIG_HMM_FRAMEBUFFER_PTR + 0x05U)  // MEMORY POOL START (0x1)

#define XP_XPU_CONFIG_HMM_SMPTR    (XP_XPU_CONFIG_HMM_FRAMEMEMPOOL_PTR + 0x05U) // STATE MACHINE POINTER (0x2)
