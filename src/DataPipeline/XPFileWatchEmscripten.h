...
class XPFileWatchEmscripten final : public XPIFileWatch
{
  public:
    XPFileWatchEmscripten(XPRegistry* const registry);
    ~XPFileWatchEmscripten() final;
    void               start(XPDPStore*         store,
                             ...
                             const std::string& pluginsDirectory) final;
    void               stop() final;
    XPDPStore&         getStore() const final;
