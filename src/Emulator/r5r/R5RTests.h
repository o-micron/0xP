...
testTriangle()
{
    ...
    Triangle<T>::generateTangentsAndBiTangents(scene.meshes[0].vertices[0].xyz,
...
testTriangles()
{
    ...
    Triangle<T>::generateTangentsAndBiTangents(scene.meshes[1].vertices[0].xyz,
    ...
    Triangle<T>::generateTangentsAndBiTangents(scene.meshes[2].vertices[0].xyz,
    ...
    Triangle<T>::generateTangentsAndBiTangents(scene.meshes[3].vertices[0].xyz,
...
template<typename T>
void
testImport(const char* filename)
{
    LOG_DEBUG("=================================================================================");
    LOGV_DEBUG("START TEST {}", filename);
    LOG_DEBUG("=================================================================================");
